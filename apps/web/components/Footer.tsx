        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/rides/find" className="hover:text-teal-400 transition">Find Rides</Link></li>
              <li><Link href="/dashboard" className="hover:text-teal-400 transition">Dashboard</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-white font-semibold text-sm mb-3">Security & PostGIS</h4>
            <ul className="space-y-2 text-sm">
              <li><span className="text-slate-400">500m Proximity Matching</span></li>
          ...
          <div>
            <h4 className="text-white font-semibold text-sm mb-3">Verification</h4>
            <ul className="space-y-2 text-sm">
              <li><span className="text-slate-400">.edu & .ac.in Domains</span></li>
              <li><span className="text-slate-400">Argon2id & JWT Auth</span></li>
              <li><span className="text-slate-400">Socket.IO WebSockets</span></li>
            </ul>
          </div>
        </div>
